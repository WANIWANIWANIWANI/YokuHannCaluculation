...
for k in range(1, n + 1):  # range(1,n+1):				 	#根から k 枚目のリブ
    ...
    diffEndChordRootChord = RootChord - EndChord
    teaperAbsoluteLength = diffEndChordRootChord / ketaLength
    taperedRootChord = c + teaperAbsoluteLength * thicknessOfRib[k - 1] / 2
    teaperedEndChord = c - teaperAbsoluteLength * thicknessOfRib[k - 1] / 2
    C = [teaperedEndChord, taperedRootChord]
    # 1回目の出力と2回目の出力を区別するための変数
    counter = 0
    for c in C:
        counter += 1
        # 翼型を上下別に関数に近似。 上下一緒に近似する方法は思いつかなかった。 fはfunctionの略
        ...
        RibCap_dPs = offset(
            [FoilD[i] for i in range(len(FoilD) - 2) if FoilD[i + 2].x >= x_plank_d],
            t,
            0,
        )

        StringerU = stringer(
            div_P(PlankPsU[0], PlankPs[1], x_plank_u, 0), PlankPs[1], e
        )
        StringerDL = stringer(
        ...
        if counter == 1:
            ...
            stringerD2ToVec = stringer(
                div_P(stringerD2[0], stringerD2[1], x_stringer_D2, 0),
                stringerD2[0],
                e,
                R=True,
            )
            ...
            stringerD3ToVec = stringer(
                div_P(stringerD3[0], stringerD3[1], x_stringer_D3, 0),
                stringerD3[0],
                e,
                R=True,
            )
            ...
            Pipe = ellipse(
                Pipe_C,
                Pipe_C + vector(0, 1).rotate(RibAngle, "radian") * (d + dd) / 2,
                d / 2,
            )
            ...
            if use_l:
                ...
                LeadEndP2D = (
                    ...
                    + (
                        (
                            vector(LeadPs[-1].x - tp, f_pd(LeadPs[-1].x - tp))
                            - LeadPs[-1]
                        )
                        / abs(
                            vector(LeadPs[-1].x - tp, f_pd(LeadPs[-1].x - tp))
            ...
            sankakkeiObject_1 = makeSannkakuNikunukiObject(
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u1_Zenenn, -0.50
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u2_Zenenn, -0.20
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d1_Zenenn, 0.20
                ),
            )

            sankakkeiObject_2 = makeSannkakuNikunukiObject(
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u3_Zenenn, -0.20
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d2_Zenenn, 0.20
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d3_Zenenn, 0.20
                ),
            )

            sankakkeiObject_3 = makeSannkakuNikunukiObject(
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u4_Zenenn, -0.20
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u5_Zenenn, -0.20
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d4_Zenenn, 0.20
                ),
            )

            sankakkeiObject_4 = makeSannkakuNikunukiObject(
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u6_Zenenn, -0.20
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d5_Zenenn, 0.20
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d6_Zenenn, 0.20
                ),
            )

            sankakkeiObject_5 = makeSannkakuNikunukiObject(
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u1_Kouenn, -0.25
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u2_Kouenn, -0.25
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d1_Kouenn, 0.30
                ),
            )

            sankakkeiObject_6 = makeSannkakuNikunukiObject(
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u3_Kouenn, -0.25
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d2_Kouenn, 0.30
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d3_Kouenn, 0.30
                ),
            )

            sankakkeiObject_7 = makeSannkakuNikunukiObject(
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u4_Kouenn, -0.25
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u5_Kouenn, -0.25
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d4_Kouenn, 0.30
                ),
            )

            sankakkeiObject_8 = makeSannkakuNikunukiObject(
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d6_Kouenn, 0.30
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d5_Kouenn, 0.30
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u6_Kouenn, -0.25
                ),
            )

            sankakkeiObject_9 = makeSannkakuNikunukiObject(
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_d7_Kouenn, 0.30
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u8_Kouenn, -0.50
                ),
                convertYokugennRateGaishuuyohakuToZahyou(
                    nikunukiBasePoint_u7_Kouenn, -0.25
                ),
            )
        ...
        if counter == 1:
            ...
            WriteText(
                file,
                vector(c * 0.05, O.y + f_camber(c * 0.05)),
                f"{PlaneNumber}-{k}",
                height=7,
            )
