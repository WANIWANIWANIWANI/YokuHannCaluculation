...
ProjectName = "0922桁穴check3翼"
# 翼型を保管しておき、コマンドファイルを出力するディレクトリのPath
directry = r"C:\Users\ryota2002\Documents\test"
# 実際にファイルを吐き出す場所
readingFilePath = r"C:\Users\ryota2002\Documents\test\桁穴チェック0922.xlsx"
...
RootFoilName = "DAE-41 normalized.dat"
EndFoilName = "DAE-41 normalized.dat"
# リブ枚数
n = 23
# 何翼?
PlaneNumber = "4"
